...
.status-badge.fail .badge-dot { background: #f0abfc; }
.status-badge.ok { color: #c4b5fd; }
.status-badge.fail { color: #f0abfc; }
...
.webhook-test-result.fail { color: #f0abfc; }
...
.ai-copy-btn.fail { background: #f0abfc; color: #110a26; }
