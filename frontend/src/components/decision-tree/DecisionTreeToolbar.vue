...
<style>
.topbar { display: flex; align-items: center; gap: 1rem; padding: 0.75rem 1.25rem; border-bottom: 1px solid #222; }
...
.synthesize-all-btn, .score-all-btn, .foresight-btn, .map-view-btn, .depth-btn, .story-btn, .auto-grow-btn, .infographic-btn { padding: 0.4rem 0.8rem; border-radius: 4px; cursor: pointer; font-family: inherit; font-size: 0.85rem; font-weight: 500; margin-left: 0.5rem; }
...
@media (max-width: 900px) { .topbar { flex-wrap: wrap; } .topic { flex-basis: 100%; } }
</style>
