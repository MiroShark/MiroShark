...
.debug-badge--round_boundary { background: rgba(255,179,71,0.2); color: #fcd34d; }
...
.debug-badge--error { background: rgba(240, 171, 252,0.2); color: #f0abfc; }
...
.debug-latency--medium { color: #fcd34d; }
.debug-latency--slow { color: #f0abfc; }
